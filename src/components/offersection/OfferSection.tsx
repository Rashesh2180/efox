...
const OfferSection = () => {
  return (
    <section className="max-w-[118.25rem] sm:pb-44 pb-20 mx-auto px-7 lg:flex xl:gap-7 gap-6 grid grid-cols-2 w-full items-end">
      <div className="sm:py-20 py-14 bg-black rounded-lg sm:px-5 px-14 2xl:px-10 min-w-72 lg:max-w-[29.5rem] grow max-lg:w-full">
       <div className="lg:max-w-80 max-w-60">
      ...
      <div className="rounded-lg bg-bordercolor lg:max-w-[22.31rem] max-lg:w-full overflow-hidden">
        <Image
          ...
          height={100}
          width={100}
          className="lg::h-[18.75rem] h-80 sm:h-[21rem] min-w-48 w-full object-cover object-top"
        />
      </div>
      ...
      <div className="bg-secondary2 max-lg:w-full grow rounded-lg text-center lg:max-w-[22.56rem] px-5 flex flex-col justify-center items-center py-24 sm:py-[8.5rem]">
        <span className="text-primary xl:text-7xl sm:text-4xl text-7xl  font-semibold tracking-letterspace2 leading-[6.56rem] mb-1">
          -50%
        </span>
